                ...
                return (
                  ...
                  >
                    {TABLE_COLS.map(col => {
                      ...
                      return (
                        <td key={col.key} style={{ padding:'10px 12px', textAlign:'center', fontSize:14, fontFamily:"'Barlow Condensed',sans-serif", color:sortKey===col.key?'var(--gold)':col.highlight?'var(--blue)':'var(--muted)', fontWeight:sortKey===col.key?700:400 }}>{val}</td>
                      )
                    })}
                  </tr>
                )
