  ...
  return (
    <div style={{
      ...
      <div style={{ display:'flex', alignItems:'center', gap:8, padding:'0 16px', borderRight:'1px solid rgba(255,255,255,0.1)', flexShrink:0 }}>
        ...
        <span style={{ fontFamily:"'Barlow Condensed',sans-serif", fontWeight:700, fontSize:13, color:'rgba(255,255,255,0.5)' }}>2026</span>
      </div>
      ...
      <div style={{ display:'flex', alignItems:'stretch' }}>
        {games.map(g => {
          ...
          return (
            <div key={g.id} style={{ display:'flex', flexDirection:'column', justifyContent:'center', padding:'5px 16px', borderRight:'1px solid rgba(255,255,255,0.08)', flexShrink:0, gap:2 }}>
              {/* Date/time — brighter */}
              <div style={{ fontSize:10, fontWeight:700, letterSpacing:'.08em', color:'rgba(255,255,255,0.6)', textTransform:'uppercase' }}>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:6 }}>
                ...
                <span style={{ fontSize:11, color:'rgba(255,255,255,0.55)', fontWeight:600 }}>{away ? `${away.w}-${away.l}` : ''}</span>
              </div>
              {/* Home — clickable */}
              <div style={{ display:'flex', alignItems:'center', gap:6 }}>
                ...
                <span style={{ fontSize:11, color:'rgba(255,255,255,0.55)', fontWeight:600 }}>{home ? `${home.w}-${home.l}` : ''}</span>
              </div>
            </div>
          )
        })}
