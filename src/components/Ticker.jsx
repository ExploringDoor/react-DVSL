    ...
    <div style={{
      ...
      <div style={{ display:'flex', alignItems:'stretch' }}>
        {games.map(g => {
          ...
          return (
            <div key={g.id} style={{ display:'flex', flexDirection:'column', justifyContent:'center', padding:'5px 10px', borderRight:'1px solid rgba(255,255,255,0.08)', flexShrink:0, gap:2 }}>
              {/* Date/time — brighter */}
